...
class WorkflowHierarchy(models.Model):
    ...
    # Ces champs sont la liste des IDs valides pour le domaine dynamique dans la vue.
    ...
    def _trigger_compute_filtered_elements(self):
        ...
        """
        # Appelle la méthode compute pour recalculer les listes filtrées
        self._compute_filtered_elements()
        # Le retour vide force Odoo à reconnaître le changement pour la vue.
        return {}
